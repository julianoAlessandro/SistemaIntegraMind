...
public class PacienteView extends javax.swing.JPanel {
    ...
    private boolean abrindoFicha = false;
    ...
    private void initComponents() {
        ...
        jPanel6.add(txtTelefoneCelular, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 0);
        jPanel6.add(txtTelefoneComercial, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 0);
        jPanel6.add(txtTelefoneFixo, gridBagConstraints);
        ...
        jLabel26.setText("Contatos de Emergência");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 2;
        ...
        txtIdade.setMaximumSize(new java.awt.Dimension(250, 30));
        txtIdade.setMinimumSize(new java.awt.Dimension(210, 30));
                ...
                if (evt.getClickCount() == 1) {
                    ...
                    if (coluna == 11 && linha >= 0) {
                        ...
                        try {
                            ...
                            // Libera para poder abrir outra ficha depois
                            abrindoFicha = false;
                        }
